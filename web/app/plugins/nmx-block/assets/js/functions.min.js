...
jQuery(function ($) {
  ...
  var BoilerplatePaginationGridCardPost = function BoilerplatePaginationGridCardPost() {
    var $wrap = $(".boilerplate-grid-card-post-block");
    if (!$wrap.length) return;
    var $itemWrap = $wrap.find(".boilerplate-grid-card-post-wrap"),
        $paginationWrap = $wrap.find(".boilerplate-pagination-wrap");
    var query = $wrap.data("query"),
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                rs = _context.sent;
                items = rs.items, pagination = rs.pagination, _query = rs.query;
                _context.next = 10;
                return $wrap.data("query", _query);

              case 10:
                _context.next = 12;
                return $itemWrap.html(items);

              case 12:
                _context.next = 14;
                return $paginationWrap.html(pagination);

              case 14:
                _context.next = 16;
                return $wrap.removeClass("__is-loading");
...
jQuery(function ($) {
  ...
  var BoilerplateHeroScroll = function BoilerplateHeroScroll() {
    var $isBlock = $('.boilerplate-hero-block');
    if (!$isBlock.length) return;
    var $ctaScroll = $isBlock.find('.boilerplate-hero-block-button-scroll__icon');
    $ctaScroll.click(function () {
      var $dataScroll = $(this).data('scroll');

      if ($dataScroll.length > 0) {
        $('html, body').animate({
          scrollTop: $("".concat($dataScroll)).offset().top
        }, 1000);
      }
    });
  };

  var BoilerplateAccordion = function BoilerplateAccordion() {
    var $accordionBlock = $('.boilerplate-accordion-block');
    if (!$accordionBlock.length) return;
    var $ctaAccordion = $accordionBlock.find('.qa-question');
  ...
  var BoilerplateCardSlider = function BoilerplateCardSlider() {
    var $cardsSliders = $('.boilerplate-card-sliders');
    if (!$cardsSliders.length) return;
    var $data = $cardsSliders.data('boilerplate-slider');
  ...
  var BoilerplatePostSlider = function BoilerplatePostSlider() {
    var $cardsSliders = $('.boilerplate-grid-card-post-block__slider');
    if (!$cardsSliders.length) return;
    var $data = $cardsSliders.data('boilerplate-slider');
    $cardsSliders.slick({
      slidesToShow: $data.slidesToShow ? $data.slidesToShow : 2,
  ...
  var BoilerplateVideo = function BoilerplateVideo() {
...
},{"./core":"core.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
